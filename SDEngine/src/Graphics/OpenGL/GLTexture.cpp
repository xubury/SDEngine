...
void GLTexture::SetWrap(TextureWrap wrap) {
    ...
    glTextureParameteri(gl_id, GL_TEXTURE_WRAP_R, gl_wrap);
    glTextureParameteri(gl_id, GL_TEXTURE_WRAP_S, gl_wrap);
    glTextureParameteri(gl_id, GL_TEXTURE_WRAP_T, gl_wrap);
}
